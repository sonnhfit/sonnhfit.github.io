...
- Unsupervised representation learning with deep convolutional generative adversarial networks(2015), A. Radford et al. [pdf](https://arxiv.org/1511.06434v2)
...
- Large-scale video classification with convolutional neural networks(2014), A. Karpathy et al. [pdf](http://vision.stanford.edu/karpathy14.pdf)
...
- Efficient estimation of word representations in vector space(2013), T. Mikolov et al.  [pdf](http://arxiv.org/1301.3781)
